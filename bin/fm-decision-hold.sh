...
# and verifies structured tasks-axi captain holds, and records completion
# attestation in the originating task's metadata.
#
...
#
# The routed `resolve` shape requires every task to exist and be blocked by the hold.
