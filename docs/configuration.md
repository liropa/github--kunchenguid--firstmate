...
FM_SBX_GUEST_ACTIVE_WINDOW=120   # sbx-only: seconds a guest-active breadcrumb or in-guest child status/turn-ended file counts as recent work for keep-alive release and stranding suppression; docs/sbx-backend.md owns the behavior
