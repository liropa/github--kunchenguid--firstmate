...
Verified at the beacon level 2026-07-27 (this tree, `bash tests/fm-watch-sbx-signals.test.sh`), covering both directions - the silence cases are proven silent, not asserted:
