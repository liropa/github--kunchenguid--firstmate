...
For sbx-backed secondmates, [`docs/sbx-backend.md`](../../../docs/sbx-backend.md#guest-home-provisioning-read-through-inheritance) owns the guest read paths, including [shared captain delivery](../../../docs/sbx-backend.md#shared-captain-delivery-2026-08-09).
...
<!-- fm-authority: captain-decision 2026-08-09 - approved under decision key skill-one-owner as the permitted one-line reinforcement at its risk point -->
