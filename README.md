...
- [docs/claude-settings-trust-posture.md](docs/claude-settings-trust-posture.md) - the accepted branch-carried claude project-settings posture, its scoped evidence, and the dispatch-time drift report.
